...
from urbanmap.model.parcelles import Parcelle
...
class ParcellesController(BaseController):
    readonly = True # if set to True, only GET is supported

    def __init__(self):
        self.protocol = Protocol(Session, Parcelle, self.readonly)
    ...
    def index(self, format='json'):
        ...
        #
        # default_filter = create_default_filter(request, Parcelle)
        # filter = and_(default_filter, Parcelle.columname.ilike('%value%'))
